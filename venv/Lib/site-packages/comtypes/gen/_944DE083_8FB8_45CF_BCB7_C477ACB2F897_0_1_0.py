...
__all__ = [
    'UIA_SayAsInterpretAsAttributeId', 'UIA_ChangesEventId',
    'ConnectionRecoveryBehaviorOptions', 'OrientationType_Horizontal',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_DocumentControlTypeId', 'NotificationKind_ActionAborted',
    'IUIAutomation3', 'UIA_IndentationTrailingAttributeId',
    'IUIAutomationStylesPattern', 'UIA_FontSizeAttributeId',
    'HeadingLevel1', 'NavigateDirection_PreviousSibling',
    'UIA_WindowPatternId', 'Assertive',
    'IUIAutomationSynchronizedInputPattern', 'UIA_MenuClosedEventId',
    'AnnotationType_ExternalChange', 'UIA_FullDescriptionPropertyId',
    'UIA_ScrollItemPatternId', 'UIA_UnderlineColorAttributeId',
    'SynchronizedInputType_LeftMouseDown', 'UIA_StyleNameAttributeId',
    'UIA_Transform2CanZoomPropertyId', 'UIA_TextChildPatternId',
    'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_AfterParagraphSpacingAttributeId',
    'UIA_SelectionActiveEndAttributeId', 'UIA_CulturePropertyId',
    'StructureChangeType_ChildrenBulkRemoved', 'StructureChangeType',
    'UIA_IsSubscriptAttributeId', 'TreeTraversalOptions_PostOrder',
    'UIA_TableColumnHeadersPropertyId',
    'UIA_DropTarget_DragEnterEventId', 'TreeTraversalOptions_Default',
    'UIA_Text_TextSelectionChangedEventId',
    'CoalesceEventsOptions_Disabled', 'NavigateDirection_LastChild',
    'TreeScope_Subtree', 'UIA_FlowsToPropertyId',
    'UIA_ValuePatternId', 'IRawElementProviderSimple',
    'IUIAutomationElement', 'AnnotationType_DeletionChange',
    'IUIAutomationOrCondition',
    'UIA_IsStylesPatternAvailablePropertyId', 'StyleId_Heading9',
    'IUIAutomationDragPattern', 'UIA_DescribedByPropertyId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'StructureChangeType_ChildrenInvalidated',
    'TreeScope_Descendants', 'IUIAutomationProxyFactory',
    'PropertyConditionFlags_None', 'UIA_DragDropEffectPropertyId',
    'TreeScope_Ancestors', 'ProviderOptions_RefuseNonClientSupport',
    'IUIAutomationEventHandler', 'IUIAutomationTextEditPattern',
    'NotificationProcessing_All', 'UIA_AppBarControlTypeId',
    'StyleId_Heading8', 'UIA_HostedFragmentRootsInvalidatedEventId',
    'UIA_CaretBidiModeAttributeId', 'StyleId_Subtitle',
    'UIA_Text_TextChangedEventId',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_DataItemControlTypeId', 'StructureChangeType_ChildRemoved',
    'UIA_LocalizedLandmarkTypePropertyId',
    'UIA_IsWindowPatternAvailablePropertyId',
    'UIA_IndentationFirstLineAttributeId',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'IUIAutomationDockPattern', 'HeadingLevel7',
    'AutomationElementMode', 'HeadingLevel5',
    'UIA_SpreadsheetItemPatternId', 'UIA_SemanticZoomControlTypeId',
    'AnnotationType_Footnote', 'WindowInteractionState_Closing',
    'UIA_IsTextPatternAvailablePropertyId', 'UIA_DropTargetPatternId',
    'AnnotationType_Mathematics', 'UIA_IsDataValidForFormPropertyId',
    'IUIAutomationTransformPattern2', 'AnnotationType_FormatChange',
    'UIA_IsTablePatternAvailablePropertyId',
    'UIA_SelectionSelectionPropertyId', 'UIA_AutomationIdPropertyId',
    'UIA_WindowIsTopmostPropertyId', 'TextEditChangeType',
    'SynchronizedInputType_KeyUp', 'UIA_CustomNavigationPatternId',
    'UIA_MenuOpenedEventId', 'UIA_GridItemRowSpanPropertyId',
    'DockPosition_Fill', 'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_TextControlTypeId', 'UIA_BackgroundColorAttributeId',
    'UIA_CalendarControlTypeId', 'UIA_ControllerForPropertyId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'IUIAutomationTextRange2',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'UIA_PaneControlTypeId', 'UIA_SpreadsheetPatternId',
    'IUIAutomationRangeValuePattern', 'StyleId_NumberedList',
    'UIA_SelectionIsSelectionRequiredPropertyId', 'DockPosition_None',
    'StyleId_Heading2',
    'WindowInteractionState_ReadyForUserInteraction',
    'IUIAutomationNotificationEventHandler',
    'TextPatternRangeEndpoint', 'HeadingLevel6',
    'IUIAutomationTreeWalker', 'UIA_TableControlTypeId',
    'UIA_TextFlowDirectionsAttributeId',
    'UIA_StrikethroughColorAttributeId', 'UIA_IsReadOnlyAttributeId',
    'UIA_CaretPositionAttributeId',
    'IUIAutomationPropertyChangedEventHandler',
    'StructureChangeType_ChildrenBulkAdded', 'Polite',
    'UIA_HeadingLevelPropertyId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_SizePropertyId', 'UIA_TreeControlTypeId',
    'UIA_SynchronizedInputPatternId',
    'UIA_RangeValueMaximumPropertyId', 'UIA_CheckBoxControlTypeId',
    'UIA_TransformPattern2Id',
    'UIA_StylesExtendedPropertiesPropertyId',
    'NotificationProcessing', 'UIA_InputReachedOtherElementEventId',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_StylesFillColorPropertyId', 'TextEditChangeType_Composition',
    'UIA_MenuBarControlTypeId', 'NavigateDirection',
    'UIA_ControlTypePropertyId', 'UIA_TextPattern2Id',
    'IUIAutomationTablePattern',
    'IUIAutomationSpreadsheetItemPattern', 'AnnotationType_Comment',
    'UIA_IsHiddenAttributeId', 'StyleId_Heading5',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'ScrollAmount_LargeDecrement',
    'IUIAutomationVirtualizedItemPattern',
    'UIA_ClickablePointPropertyId',
    'UIA_IsGridPatternAvailablePropertyId', 'UIA_CustomControlTypeId',
    'IUIAutomationChangesEventHandler', 'UIA_ComboBoxControlTypeId',
    'StyleId_Custom', 'StyleId_Quote', 'UIA_LevelPropertyId',
    'StyleId_BulletedList', 'UIA_ScrollHorizontalViewSizePropertyId',
    'IUIAutomationTextRange3', 'UIA_WindowControlTypeId',
    'UIA_CustomLandmarkTypeId', 'UIA_MultipleViewPatternId',
    'UIA_MenuModeEndEventId', 'UIA_StylesShapePropertyId',
    'UIA_OrientationPropertyId', 'UIA_UnderlineStyleAttributeId',
    'UIA_TextEditPatternId', 'Off', 'AnnotationType_TrackChanges',
    'IUIAutomation4', 'UIA_IsSelectionItemPatternAvailablePropertyId',
    'NotificationProcessing_MostRecent', 'UIA_GroupControlTypeId',
    'SupportedTextSelection_None',
    'UIA_AutomationFocusChangedEventId',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'UIA_ValueValuePropertyId', 'IUIAutomationNotCondition',
    'UIA_MenuControlTypeId', 'UIA_OutlineStylesAttributeId',
    'UIA_Window_WindowClosedEventId',
    'NotificationProcessing_CurrentThenMostRecent',
    'UIA_DragPatternId', 'ExpandCollapseState',
    'UIA_IsDragPatternAvailablePropertyId',
    'ScrollAmount_LargeIncrement', 'DockPosition_Left',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_StylesStyleNamePropertyId', 'IUIAutomationElement5',
    'UIA_AsyncContentLoadedEventId', 'UIA_StylesStyleIdPropertyId',
    ...
    'UIA_IsSpreadsheetPatternAvailablePropertyId', 'RowOrColumnMajor',
    'UIA_SeparatorControlTypeId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'UIA_TransformPatternId', 'UIA_HyperlinkControlTypeId',
    'IUIAutomationElement9', 'UIA_AnnotationPatternId',
    'ZoomUnit_SmallIncrement', 'UIA_TabControlTypeId',
    'UIA_WindowIsModalPropertyId', 'UIA_MarginLeadingAttributeId',
    'UIA_HasKeyboardFocusPropertyId', 'UIA_ItemStatusPropertyId',
    ...
    'UIA_GridRowCountPropertyId', 'IUIAutomationTextPattern',
    'StructureChangeType_ChildAdded', 'UIA_StylesPatternId',
    'UIA_LineSpacingAttributeId', 'UIA_MenuModeStartEventId',
    'UIA_ItemTypePropertyId', 'UIA_Selection_InvalidatedEventId',
    'UIA_ProcessIdPropertyId', 'UIA_SliderControlTypeId',
    'UIA_RotationPropertyId',
    'TextEditChangeType_CompositionFinalized',
    'AnnotationType_InsertionChange', 'IUIAutomationSelectionPattern',
    'UIA_HeaderItemControlTypeId', 'SynchronizedInputType_KeyDown',
    'AnnotationType_Author', 'UIA_ListItemControlTypeId',
    'ProviderOptions_ProviderOwnsSetFocus',
    'UIA_Drag_DragCompleteEventId',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_IsInvokePatternAvailablePropertyId', 'UIA_GridPatternId',
    'ProviderOptions_NonClientAreaProvider',
    'ScrollAmount_SmallIncrement', 'UIA_ToolTipClosedEventId',
    'IUIAutomationCondition', 'UIA_SplitButtonControlTypeId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'ExpandCollapseState_LeafNode', 'ZoomUnit_LargeIncrement',
    'UiaChangeInfo', 'UIA_Window_WindowOpenedEventId',
    'UIA_AriaPropertiesPropertyId', 'IUIAutomationTableItemPattern',
    'HeadingLevel8', 'UIA_AnnotationObjectsPropertyId',
    'UIA_FlowsFromPropertyId', 'UIA_TableRowHeadersPropertyId',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'TreeTraversalOptions', 'TextUnit', 'IUIAutomationElement7',
    'UIA_OverlineStyleAttributeId', 'UIA_FrameworkIdPropertyId',
    'AnnotationType_EditingLockedChange',
    'IUIAutomationItemContainerPattern',
    'UIA_LegacyIAccessibleNamePropertyId', 'UIA_ScrollPatternId',
    'WindowVisualState_Maximized', 'ScrollAmount_SmallDecrement',
    'WindowVisualState_Minimized',
    'UIA_IsTextPattern2AvailablePropertyId',
    'ProviderOptions_HasNativeIAccessible',
    'AnnotationType_GrammarError', 'IUIAutomationCacheRequest',
    'UIA_RuntimeIdPropertyId', 'TextUnit_Format',
    'UIA_RangeValueLargeChangePropertyId',
    'UIA_ActiveTextPositionChangedEventId', 'DockPosition_Top',
    'UIA_Selection2ItemCountPropertyId',
    'SynchronizedInputType_LeftMouseUp',
    'TextPatternRangeEndpoint_Start', 'UIA_NavigationLandmarkTypeId',
    'WindowInteractionState_Running', 'HeadingLevel3',
    'ExpandCollapseState_Expanded',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_HelpTextPropertyId', 'UIA_IsContentElementPropertyId',
    'UIA_GridItemColumnSpanPropertyId', 'UIA_ClassNamePropertyId',
    'UIA_SelectionItemPatternId', 'TextUnit_Word',
    'AutomationElementMode_Full', 'IUIAutomationElement8',
    'UIA_VisualEffectsPropertyId', 'UIA_DataGridControlTypeId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'ExpandCollapseState_PartiallyExpanded',
    'UIA_GridColumnCountPropertyId', 'IUIAutomationPropertyCondition',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_TableItemPatternId', 'IUIAutomationTextChildPattern',
    'IUIAutomationCustomNavigationPattern',
    'UIA_Transform2ZoomLevelPropertyId',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_TableRowOrColumnMajorPropertyId', 'UIA_SearchLandmarkTypeId',
    'UIA_LegacyIAccessiblePatternId',
    'UIA_LegacyIAccessibleStatePropertyId',
    'UIA_IsSelectionPattern2AvailablePropertyId', 'IAccessible',
    'DockPosition_Right', 'TextEditChangeType_None',
    'IUIAutomationTransformPattern', 'ZoomUnit',
    'AnnotationType_MoveChange', 'IUIAutomationElement4',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_CapStyleAttributeId', 'IUIAutomationProxyFactoryMapping',
    'UIA_TabItemControlTypeId', 'UIA_FontWeightAttributeId',
    'UIA_AnnotationTargetPropertyId', 'UIA_FillTypePropertyId',
    'IUIAutomationTextRangeArray', 'OrientationType_Vertical',
    'DockPosition_Bottom', 'SynchronizedInputType_RightMouseDown',
    'ToggleState_Off', 'UIA_LegacyIAccessibleHelpPropertyId',
    'IUIAutomationFocusChangedEventHandler',
    'UIA_ButtonControlTypeId', 'AnnotationType_Highlighted',
    'UIA_RangeValuePatternId', 'IUIAutomationElement6',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'UIA_AnnotationObjectsAttributeId', 'UIA_ToolTipControlTypeId',
    'UIA_SelectionItemIsSelectedPropertyId', 'TextUnit_Page',
    'HeadingLevel9', 'UIA_LayoutInvalidatedEventId',
    'IUIAutomationSelectionPattern2', 'UIA_IsActiveAttributeId',
    'IUIAutomationScrollItemPattern',
    'ProviderOptions_ServerSideProvider', 'UIA_TitleBarControlTypeId',
    'UIA_TransformCanMovePropertyId', 'ExtendedProperty',
    'UIA_MainLandmarkTypeId', 'UIA_LiveSettingPropertyId',
    'UIA_NativeWindowHandlePropertyId', 'AutomationElementMode_None',
    'CoalesceEventsOptions_Enabled', 'UIA_EditControlTypeId',
    'UIA_OutlineThicknessPropertyId', 'NotificationKind',
    'UIA_Transform2ZoomMinimumPropertyId', 'CUIAutomation8',
    'TextUnit_Character', 'UIA_TreeItemControlTypeId',
    'OrientationType_None', 'IUIAutomationValuePattern',
    ...
    'UIA_DockPatternId', 'UIA_ItemContainerPatternId',
    'UIA_FontNameAttributeId', 'UIA_IsItalicAttributeId',
    'UIA_ScrollVerticallyScrollablePropertyId', 'LiveSetting',
    'UIA_ScrollBarControlTypeId', 'UIA_FormLandmarkTypeId',
    'UIA_LocalizedControlTypePropertyId', 'StyleId_Heading3',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'ZoomUnit_LargeDecrement', 'StyleId_Heading6', 'ScrollAmount',
    'UIA_IsSuperscriptAttributeId', 'UIA_RadioButtonControlTypeId',
    'HeadingLevel_None', 'UIA_ImageControlTypeId',
    'TreeScope_Children', 'IUIAutomation',
    'ConnectionRecoveryBehaviorOptions_Enabled', 'IUIAutomation5',
    'UIA_GridItemPatternId', 'ExpandCollapseState_Collapsed',
    'UIA_HeaderControlTypeId', 'UIA_LinkAttributeId',
    'UIA_ScrollVerticalViewSizePropertyId',
    'UIA_PositionInSetPropertyId', 'UIA_ValueIsReadOnlyPropertyId',
    'UIA_ToolBarControlTypeId', 'ToggleState', 'UIA_NamePropertyId',
    'NotificationKind_ItemRemoved', 'UIA_VirtualizedItemPatternId',
    'SupportedTextSelection_Single', 'SynchronizedInputType',
    'RowOrColumnMajor_ColumnMajor', 'TextPatternRangeEndpoint_End',
    'AnnotationType_DataValidationError', 'IUIAutomationElement2',
    'HeadingLevel2', 'SynchronizedInputType_RightMouseUp',
    'UIA_WindowCanMinimizePropertyId',
    'IUIAutomationEventHandlerGroup',
    'UIA_IndentationLeadingAttributeId',
    'NavigateDirection_NextSibling',
    'AnnotationType_AdvancedProofingIssue',
    'UIA_DropTargetDropTargetEffectPropertyId', 'DockPosition',
    'UIA_IsTransformPatternAvailablePropertyId',
    'IUIAutomationWindowPattern',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'AnnotationType_Sensitive', 'StyleId_Normal',
    'UIA_TabsAttributeId', 'UIA_CultureAttributeId',
    'IUIAutomationTextPattern2',
    'UIA_IsDockPatternAvailablePropertyId',
    'NotificationKind_ItemAdded', 'UIA_ExpandCollapsePatternId',
    'AnnotationType_Endnote',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'IUIAutomationAnnotationPattern',
    'IUIAutomationProxyFactoryEntry', 'UIA_SizeOfSetPropertyId',
    'AnnotationType_UnsyncedChange', 'AnnotationType_Unknown',
    'UIA_OptimizeForVisualContentPropertyId',
    'UIA_OverlineColorAttributeId', 'UIA_IsDialogPropertyId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_InputDiscardedEventId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_IsEnabledPropertyId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_AnimationStyleAttributeId', 'TextUnit_Document',
    'UIA_GridItemRowPropertyId', 'TextEditChangeType_AutoCorrect',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_ThumbControlTypeId', 'UIA_IsRequiredForFormPropertyId',
    'HeadingLevel4', 'TreeScope_None',
    'IUIAutomationSelectionItemPattern', 'UIA_NotificationEventId',
    'UIA_Transform2ZoomMaximumPropertyId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'CUIAutomation', 'IUIAutomationMultipleViewPattern',
    'IUIAutomationAndCondition', 'UIA_WindowCanMaximizePropertyId',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_ObjectModelPatternId', 'PropertyConditionFlags',
    'NotificationProcessing_ImportantAll', 'StyleId_Heading1',
    'UIA_CenterPointPropertyId',
    'UIA_AutomationPropertyChangedEventId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId', 'ToggleState_On',
    'UIA_SelectionPattern2Id',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_ListControlTypeId', 'UIA_MarginTopAttributeId',
    'UIA_IsControlElementPropertyId',
    'UIA_ProviderDescriptionPropertyId', 'StyleId_Title',
    'NotificationKind_ActionCompleted',
    'UIA_InputReachedTargetEventId',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_AnnotationAuthorPropertyId', 'UIA_ToolTipOpenedEventId',
    'NotificationProcessing_ImportantMostRecent',
    'UIA_BeforeParagraphSpacingAttributeId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'NotificationKind_Other', 'UIA_SelectionPatternId',
    ...
    'UIA_DragDropEffectsPropertyId', 'UIA_DockDockPositionPropertyId',
    'AnnotationType_SpellingError', 'WindowVisualState',
    'UIA_SayAsInterpretAsMetadataId', 'UIA_MenuItemControlTypeId',
    'StyleId_Heading4', 'UIA_SpinnerControlTypeId', 'TreeScope',
    'UIA_RangeValueSmallChangePropertyId', 'UIA_IsPasswordPropertyId',
    'UIA_StylesFillPatternColorPropertyId',
    'UIA_IsValuePatternAvailablePropertyId', 'ScrollAmount_NoAmount',
    'PropertyConditionFlags_IgnoreCase', 'UIA_LabeledByPropertyId',
    'AnnotationType_CircularReferenceError',
    'UIA_OutlineColorPropertyId', 'IUIAutomationInvokePattern',
    'UIA_LiveRegionChangedEventId', 'UIA_DragIsGrabbedPropertyId',
    'UIA_BulletStyleAttributeId', 'UIA_IsPeripheralPropertyId',
    'NavigateDirection_FirstChild', 'UIA_TogglePatternId',
    'UIA_LegacyIAccessibleDescriptionPropertyId', 'TextUnit_Line',
    'UIA_Invoke_InvokedEventId', 'UIA_SystemAlertEventId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'StructureChangeType_ChildrenReordered',
    'UIA_StructureChangedEventId', 'UIA_ToggleToggleStatePropertyId',
    'UIA_LandmarkTypePropertyId', 'ProviderOptions',
    'UIA_BoundingRectanglePropertyId', 'IUIAutomationElement3',
    ...
    'UIA_InvokePatternId', 'OrientationType',
    'UIA_DropTarget_DragLeaveEventId',
    'UIA_StylesFillPatternStylePropertyId',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'SupportedTextSelection', 'IUIAutomation2',
    'TextEditChangeType_AutoComplete', 'UIA_Drag_DragStartEventId',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_DropTarget_DroppedEventId', 'UIA_ProgressBarControlTypeId',
    'UIA_AriaRolePropertyId', 'ProviderOptions_UseClientCoordinates',
    'UIA_SummaryChangeId', 'CoalesceEventsOptions',
    'UIA_StyleIdAttributeId', 'ZoomUnit_NoAmount',
    'UIA_IsTogglePatternAvailablePropertyId',
    'IUIAutomationTextRange', 'UIA_AnnotationTypesPropertyId',
    'ProviderOptions_ClientSideProvider',
    'UIA_Drag_DragCancelEventId',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_IsOffscreenPropertyId', 'TextUnit_Paragraph',
    'UIA_AccessKeyPropertyId', 'RowOrColumnMajor_Indeterminate',
    'TreeScope_Element', 'AnnotationType_FormulaError',
    'UIA_ForegroundColorAttributeId',
    'UIA_IsKeyboardFocusablePropertyId', 'UIA_TablePatternId',
    'IUIAutomationGridPattern', 'RowOrColumnMajor_RowMajor',
    'AnnotationType_Footer', 'WindowInteractionState',
    'ZoomUnit_SmallDecrement', 'WindowInteractionState_NotResponding',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_AnnotationDateTimePropertyId', 'NavigateDirection_Parent',
    'IUIAutomationScrollPattern',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'AnnotationType_ConflictingChange',
    'UIA_LegacyIAccessibleRolePropertyId',
    'IUIAutomationElementArray', 'IUIAutomationSpreadsheetPattern',
    'IUIAutomation6', 'ProviderOptions_UseComThreading',
    ...
    'UIA_MarginTrailingAttributeId', 'ToggleState_Indeterminate',
    'UIA_AcceleratorKeyPropertyId', 'StyleId_Heading7',
    'TreeTraversalOptions_LastToFirstOrder'
]

_check_version('1.2.1', 1705776696.742630)
